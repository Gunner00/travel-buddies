...
export default function Account({ session }) {
    ...
    return (
        <>
            ...
            {filledInfo && (
                <button
                    className="fixed flex rounded-full justify-center items-center gap-4 bottom-10 left-0 right-0 w-[95vw] h-[50vw] m-auto bg-black text-white text-2xl font-medium px-10 py-4"
